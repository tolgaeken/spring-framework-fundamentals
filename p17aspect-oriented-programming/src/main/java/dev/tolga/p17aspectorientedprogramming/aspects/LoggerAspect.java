...
public class LoggerAspect {
    ...
    @Around("execution(* dev.tolga.p17aspectorientedprogramming.services.*.*(..))")
    ...
    @Around("@annotation(dev.tolga.p17aspectorientedprogramming.interfaces.LogAspect)")
    ...
    @AfterThrowing(value = "execution(* dev.tolga.p17aspectorientedprogramming.services.*.*(..))",throwing = "ex")
    ...
    @AfterReturning(value = "execution(* dev.tolga.p17aspectorientedprogramming.services.*.*(..))",returning = "retVal")
